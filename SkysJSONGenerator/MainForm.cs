        ...
        private void LoadConfig()
        {
            ...
            else
            {
                ...
                var iafProfile110 = new Profile("1.10", "ironagefurniture", new List<string>
                    ...
                    , "forestry:acacia:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:balsa:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:baobab:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:cherry:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:chestnut:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:citrus:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:cocobolo:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:ebony:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:giganteum:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:greenheart:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:ipe:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:kapok:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:larch:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:lime:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:mahoe:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:mahogany:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:maple:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:padauk:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:palm:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:papaya:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:pine:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:plum:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:poplar:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:sequoia:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:teak:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:walnut:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:wenge:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:willow:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
                    , "forestry:zebrawood:planks.{materialname}:bark.{materialname}:{materialname}_log_top"
