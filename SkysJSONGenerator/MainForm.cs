            ...
            else
            {
                ...
                var iafProfile110 = new Profile("1.10", "ironagefurniture", new List<string>
                    {  "minecraft:oak:planks_{materialname}:log_{materialname}:log_{materialname}_top"
                     ...
                     , "biomesoplenty:umbran:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:willow:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:magic:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:mahogany:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:mangrove:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:palm:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:pine:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:redwood:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:sacred_oak:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:ebony:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:ethereal:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:eucalyptus:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:fir:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:hellbark:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:jacaranda:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "biomesoplenty:cherry:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                     , "natura:amaranth:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:eucalyptus:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:hopseed:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:maple:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:redwood:{materialname}_planks:{materialname}_bark:log_{materialname}_top"
                    , "natura:sakura:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:silverbell:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:tiger:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:willow:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:bloodwood:{materialname}_planks:{materialname}_bark:log_{materialname}_top"
                    , "natura:darkwood:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:fusewood:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "natura:ghostwood:{materialname}_planks:{materialname}_log:log_{materialname}_top"
                    , "immersiveengineering:treatedWood:{materialname}_vertical:{materialname}_packaged:log_{materialname}_top"
                    , "forestry:acacia:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:balsa:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:baobab:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:cherry:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:chestnut:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:citrus:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:cocobolo:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:ebony:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:giganteum:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:greenheart:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:ipe:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:kapok:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:larch:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:lime:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:mahoe:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:mahogany:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:maple:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:padauk:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:palm:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:papaya:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:pine:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:plum:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:poplar:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:sequoia:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:teak:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:walnut:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:wenge:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:willow:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                    , "forestry:zebrawood:planks.{materialname}:bark.{materialname}:log_{materialname}_top"
                ...
                var iafProfile114 = new Profile("1.14", "ironagefurniture", new List<string>
                    {  "minecraft:oak:{materialname}_planks:{materialname}_log:ingredients:minecraft:{materialname}_planks"
                        ...
                        , "immersiveengineering:treated_wood:wooden_decoration/{materialname}_vertical:wooden_decoration/{materialname}_packaged:ingredients:immersiveengineering:{materialname}_packaged"
                         , "byg:aspen:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:baobab:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:blue_enchanted:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:bulbis:{materialname}_planks:{materialname}_planks:ingredients:byg:{materialname}_planks"
                         , "byg:cherry:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:cika:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:cypress:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:ebony:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:embur:{materialname}_planks:{materialname}_planks:ingredients:byg:{materialname}_planks"
                         , "byg:fir:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:glacial_oak:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:green_enchanted:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:holly:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:jacaranda:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:mahogany:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:mangrove:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:maple:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:pine:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:rainbow_eucalyptus:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:redwood:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:skyris:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:willow:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:witch_hazel:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
                         , "byg:zelkova:{materialname}_planks:{materialname}_log:ingredients:byg:{materialname}_planks"
